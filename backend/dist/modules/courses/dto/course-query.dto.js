...
class CourseQueryDto extends pagination_dto_1.PaginationWithSortDto {
    categoryId;
    courseType;
    status;
    teacherId;
...
], CourseQueryDto.prototype, "courseType", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(constants_1.CourseStatus, { message: '课程状态无效' }),
    __metadata("design:type", String)
], CourseQueryDto.prototype, "status", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsNumber)({}, { message: '教师ID必须是数字' }),
    __metadata("design:type", Number)
], CourseQueryDto.prototype, "teacherId", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
