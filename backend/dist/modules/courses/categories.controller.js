...
let CategoriesController = class CategoriesController {
    ...
    async findAll() {
        ...
        return response_dto_1.ApiResponse.success(categories);
    }
    async findActive() {
    ...
    async findById(id) {
        ...
        return response_dto_1.ApiResponse.success(category);
    }
    async create(createCategoryDto) {
        const category = await this.categoriesService.create(createCategoryDto);
        return response_dto_1.ApiResponse.created(category, '分类创建成功');
    }
    async update(id, updateCategoryDto) {
        const category = await this.categoriesService.update(id, updateCategoryDto);
        return response_dto_1.ApiResponse.success(category, '分类更新成功');
    }
    async remove(id) {
        await this.categoriesService.remove(id);
        return response_dto_1.ApiResponse.success(null, '分类删除成功');
    }
};
