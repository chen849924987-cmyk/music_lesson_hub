...
exports.VideosModule = VideosModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([video_entity_1.Video]), storage_module_1.StorageModule],
        controllers: [videos_controller_1.VideosController],
        providers: [videos_service_1.VideosService],
        exports: [videos_service_1.VideosService, typeorm_1.TypeOrmModule.forFeature([video_entity_1.Video])],
    })
], VideosModule);
