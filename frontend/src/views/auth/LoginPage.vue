 ...
 * LoginPage - 登录页面组件
 *
 * 功能描述：DAW（数字音频工作站）主题的登录页面，包含卷帘窗入场动画、
  ...
  <div class="login-page">
    ...
    <div class="login-container">
      <div class="login-header">
        ...
        <h1 class="login-title gradient-text">音乐教育平台</h1>
        <p class="login-subtitle">学音乐，像制作人一样思考</p>
      </div>
      ...
      <div class="vu-decor">
        <div class="vu-decor__meter">
          <span
            ...
            :key="i"
            class="vu-decor__seg"
            :class="{ 'vu-decor__seg--active': i <= 3 }"
          ></span>
        </div>
        <span class="vu-decor__label">INPUT</span>
      </div>
      ...
      >
        <el-form-item prop="username">
          <el-input v-model="loginForm.username" placeholder="用户名" class="daw-input">
            <template #prefix>
        ...
        <el-form-item>
          <el-button :loading="loading" class="login-button btn--glow" @click="handleLogin">
            {{ loading ? '演奏中...' : '开始演奏' }}
          </el-button>
        </el-form-item>
      </el-form>
      ...
      <div class="forgot-links">
        ...
        <span class="forgot-link" @click="handleForgotUsername">忘记用户名</span>
      </div>
...
const handleForgotUsername = () => {
  ElMessage.info('忘记用户名功能开发中，敬请期待');
};

/**
 * 处理登录
 * 先校验表单，成功后跳转到重定向地址或首页
 */
